...
------------------------
Pure-Python unit tests for mapping_pkg coordinate transformations,
log-odds probabilistic conversions, Bresenham ray-tracing, and synthetic crater detection.
Executed by pytest in CI (no ROS2 or Gazebo dependency).
"""
...
# Ensure src/mapping_pkg is on python path for pure Python tests
PKG_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'src', 'mapping_pkg'))
...
def test_synthetic_crater_classification():
    """Feed a hand-built grid with a circular obstacle ring and verify interior gets classified as crater (90)."""
    h, w = 120, 120
    cx, cy, r = 60, 60, 25
